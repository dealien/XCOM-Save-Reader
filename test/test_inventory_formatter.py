...
def test_format_inventory_for_display_full():
    ...
    equipment_layout = [
        {'itemType': 'STR_NITRO_EXPRESS', 'slot': 'STR_RIGHT_HAND', 'ammoItemSlots': ['STR_NITRO_EXPRESS_CLIP']},
        {'itemType': 'STR_NITRO_EXPRESS_CLIP', 'slot': 'STR_BELT'},
        {'itemType': 'STR_SMOKE_GRENADE', 'slot': 'STR_BELT', 'fuseTimer': 5},
        {'itemType': 'STR_PLASMA_RIFLE', 'slot': 'STR_LEFT_HAND', 'ammoItem': 'STR_PLASMA_RIFLE_CLIP'},
