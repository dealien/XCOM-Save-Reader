...
class MissionView(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        # Mission Name Banner
        self.mission_name_label = ctk.CTkLabel(self, text="", font=ctk.CTkFont(size=24, weight="bold"))
        ...
        participants_label = ctk.CTkLabel(participants_frame, text="Mission Participants", font=ctk.CTkFont(size=16, weight="bold"))
        ...
        # Back Button
        back_button = ctk.CTkButton(self, text="Back to Soldier View", command=self.back_to_soldier)
    ...
    def update_view(self, mission_id, from_soldier_id):
        ...
        self.mission_result_label.configure(text=f"Result: {'Success' if mission.success else 'Failure'}")
